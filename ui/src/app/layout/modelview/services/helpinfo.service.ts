...
export enum WidgetType { GROUP_TICKBOX, GROUP_TOGGLE, PART_TICKBOX, PART_CONFIG, ZOOM_VIEW, PART_EYEBALL,
                          PART_OFFSET, PART_VISIBILITY, RESET_VIEW, MOUSE_GUIDE, COMPASS_ROSE, END_TOUR }
